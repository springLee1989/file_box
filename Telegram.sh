...
tar xzf /root/zgq.conf.tar.gz -C /etc/dnsmasq.d/
	...
	if [ "`uci get system.@system[0].hostname`" == "YunLink1s-gohome" ];then
		wget --no-check-certificate  https://gitee.com/spring1989/file_box/raw/master/gohome/dns.tar.gz -O /tmp/dns.tar.gz
		tar xzf /tmp/dns.tar.gz -C /etc/dnsmasq.d/
	fi
	if [ "`uci get system.@system[0].hostname`" == "YunLink1s" ];then
	...
	if [ "`uci get system.@system[0].hostname`" == "YunLink2R" ];then
		wget --no-check-certificate  https://gitee.com/spring1989/file_box/raw/master/dns.tar.gz -O /tmp/dns.tar.gz
		tar xzf /tmp/dns.tar.gz -C /etc/dnsmasq.d/
	fi
	if [ "`uci get system.@system[0].hostname`" == "XiaoLingFirewall" ];then
		wget --no-check-certificate  https://gitee.com/spring1989/file_box/raw/master/dns.tar.gz -O /tmp/dns.tar.gz
		tar xzf /tmp/dns.tar.gz -C /etc/dnsmasq.d/
	else
		wget --no-check-certificate  https://gitee.com/spring1989/file_box/raw/master/dns.tar.gz -O /tmp/dns.tar.gz
...
if [ $cpu == "MT7620N" -a $etc_init_md5 != "00454a2f1ee97f372eef666ee9af18d8" -a "`uci get system.@system[0].hostname`" == "YunLink1s" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/2026/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi
if [ $cpu == "MT7620N" -a $etc_init_md5 != "b9c6946f0693307cb8823ab7ba2bda74" -a "`uci get system.@system[0].hostname`" == "YunLink1s-gohome" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/gohome/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi
...
if [ ! -e $obfs -a $cpu == "MT7621" -a $machine == "ZBT-WG3526" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/3526/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk -O /tmp/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/3526/libev_4.27-1_mipsel_24kc.ipk   -O /tmp/libev_4.27-1_mipsel_24kc.ipk  
	opkg install /tmp/libev_4.27-1_mipsel_24kc.ipk
	opkg install /tmp/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk
fi
if [ ! -e $obfs -a $cpu == "MT7621" -a $machine == "ZBT-WE1326" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/3526/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk -O /tmp/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/3526/libev_4.27-1_mipsel_24kc.ipk   -O /tmp/libev_4.27-1_mipsel_24kc.ipk  
	opkg install /tmp/libev_4.27-1_mipsel_24kc.ipk
	opkg install /tmp/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk
...
if [ $etc_init_md5 != "24f160002e2140a804c81abbeb81ec23" -a $cpu == "MT7621" -a $machine == "ZBT-WG3526" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/3526/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi

if [ $etc_init_md5 != "5c082502e1cf7d1eaf7dd7bec4693b9c" -a $cpu == "MT7621" -a $machine == "ZBT-WE1326" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/1326/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi
if [ ! -e $obfs -a $cpu == "AR9330" -a $machine == "GL-MIFI" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/gl_wifi/simple-obfs_v0.0.5-spring-3_mips_24kc.ipk -O /tmp/simple-obfs_v0.0.5-spring-3_mips_24kc.ipk
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/gl_wifi/libev_4.24-1_mips_24kc.ipk   -O /tmp/libev_4.24-1_mips_24kc.ipk  
...
if [ $etc_init_md5 != "2fb6b968b58b8d7ef15bf327bc9b6c7c" -a $cpu == "AR9330" -a $machine == "GL-MIFI" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/gl_wifi/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi
...
if [ ! -e $obfs -a $cpu == "MT7621" -a $machineNet == "R6220" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/R6220/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk -O /tmp/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/R6220/libev_4.27-1_mipsel_24kc.ipk   -O /tmp/libev_4.27-1_mipsel_24kc.ipk  
	opkg install /tmp/libev_4.27-1_mipsel_24kc.ipk
	opkg install /tmp/simple-obfs_v0.0.5-spring-3_mipsel_24kc.ipk
fi

if [ $etc_init_md5 != "b6fe3d72b6d04fc90450306b18dd3653" -a $cpu == "MT7621" -a $machineNet == "R6220" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/R6220/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi
...
if [ ! -e $obfs -a $DISTRIB_ARCH == "DISTRIB_ARCH='x86_64'" ];then
	wget --no-check-certificate  https://gitee.com/spring1989/file_box/raw/master/x86_64/simple-obfs_v0.0.5-spring-3_x86_64.ipk -O /tmp/simple-obfs_v0.0.5-spring-3_x86_64.ipk
	wget --no-check-certificate  https://gitee.com/spring1989/file_box/raw/master/x86_64/libev_4.22-1_x86_64.ipk   -O /tmp/libev_4.22-1_x86_64.ipk
...
if [ $etc_init_md5 != "2fb6b968b58b8d7ef15bf327bc9b6c7c" -a $DISTRIB_ARCH == "DISTRIB_ARCH='x86_64'" ];then
	wget --no-check-certificate   https://gitee.com/spring1989/file_box/raw/master/x86_64/yunlink_init.tar.gz -O /tmp/yunlink_init.tar.gz
	tar xzf /tmp/yunlink_init.tar.gz -C /etc/init.d/ 
	chmod a+x  /etc/init.d/ss-yunlink
	/etc/init.d/ss-yunlink restart
fi
...
sed -i  "s/http:\/\/dm.yunlink.win/https:\/\/www.yunlink.hn.cn/g" /usr/lib/lua/luci/view/yunlink.htm
...
#fi
#sed -i "s/208.67.220.220#443/120.77.208.19#1053/g" /etc/dnsmasq.d/fgserver.conf
#sed -i "s/120.77.208.19#1053/8.210.210.143#5353/g" /etc/dnsmasq.d/fgserver.conf
#/etc/init.d/ss-yunlink restart
